...
namespace ossServer.Controllers.Ugyfelkapcsolat
{
    public class UgyfelkapcsolatBll
    {
        ...
        public static async Task DeleteAsync(ossContext context, string sid, UgyfelkapcsolatDto dto)
        {
            ...
            await UgyfelkapcsolatDal.Lock(context, dto.Ugyfelkod, dto.Modositva);
            await UgyfelkapcsolatDal.CheckReferencesAsync(context, dto.Ugyfelkod);
            var entity = await UgyfelkapcsolatDal.GetAsync(context, dto.Ugyfelkod);
        ...
        //public static async Task<UgyfelkapcsolatDto> GetAsync(ossContext context, string sid, int key)
        //{
        //    SessionBll.Check(context, sid);
        //    await CsoportDal.JogeAsync(context, JogKod.UGYFELEK);

        //    var entity = await UgyfelkapcsolatDal.GetAsync(context, key);
        //    return Calc(entity);
        //}
